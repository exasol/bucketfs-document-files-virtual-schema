...
class BucketfsDocumentFilesAdapterIT extends AbstractDocumentFilesAdapterIT {
    private static final String ADAPTER_JAR = "document-files-virtual-schema-dist-7.2.1-bucketfs-1.2.0.jar";
    ...
    protected void createVirtualSchema(final String schemaName, final String mapping) {
        this.createdObjects.add(testDbBuilder//
                ...
                .properties(Map.of("MAPPING", mapping, "MAX_PARALLEL_UDFS", "1", "DEBUG_ADDRESS", "192.168.179.38:3000",
                        "LOG_LEVEL", "ALL"))//
                .build());
    }
